...
## Scope of this reserach: reproducibility *of* decisions versus reproducibility *for* decision-making
...
'Decision-points' in the broader decision-process must be scrutinised and incorporated into any reproducibility work in ecology and conservation.




2. Whole-of-process - we use multiple tools at various steps, especially for more complicated decision problems. Not sufficient to consider reproducibility issues for just one part of the process.
