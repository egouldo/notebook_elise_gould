...
**INTRO PARAGRAPH**
- intro sentence: what we do in applied ecology and conservation: decision-making under uncertainty. Rapid decisions. 
- Formal approaches to environmental decision-making under uncertainty, such as Structured Decision Making (SDM), are commonly touted as a means to more robust and reproducible decisions because of their inherent transparency. List examples.
- claim largely untested. very little discussion of reproducibility of decision-support in ecology and conservation beyond the throwaway claim of benefit.
- Given that science is in the grips of a broader "reproducibility crisis" or "credibility revolution" (depending on which way you spin it), within a broader socio-political climate of alternative facts and post-truthness where scientific truths are heavily scrutinised and, it's essential and timely that researchers begin examining the reproducibility of decision-support systems in ecology and conservation.
